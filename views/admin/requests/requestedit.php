      ...
      if (empty($errors)) {
          ...
          if (empty($errors)) {
              ...
              if ($stmt = $conn->prepare($sql)) {
                  ...
                  if ($result) {
                      echo "<script>alert('Request updated successfully!'); window.location.href='" . request_url($student_id) . "';</script>";
                      exit();
                  } else {
                      ...
                      <div class="form-container">
                          ...
                          <form action="" method="POST" enctype="multipart/form-data">
                              ...
                              <div class="text-center mt-2">
                                  <a href="<?php echo request_url($student_id); ?>" class="btn btn-secondary btn-lg"><i class="fas fa-times"></i> Cancel</a>
                              </div>
                          </form>
                          <?php endif; ?>
                      </div>
