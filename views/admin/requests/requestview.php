                ...
                <div class="col-md-12">
                    ...
                    <div class="table-wrap mb-4">
                        ...
                        <div class="text-end mt-2">
                            <a href="<?php echo request_url($request['student_id'], 'edit', $request['id']); ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
                            <a href="<?php echo request_url($request['student_id'], 'delete', $request['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this request?')">>
                    ...
                    <div class="text-center mt-4">
                        <a href="<?php echo student_url(); ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back to Dashboard</a>
                    </div>
                </div>
            </div>
        </div>
