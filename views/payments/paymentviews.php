            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="table-wrap">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../../views/payments/paymentedit.php?id=<?= urlencode($payment['id']) ?>&scid=<?= urlencode($scid) ?>">
                                                <button class="btn btn-primary">Edit</button>
                                            </a>
                                            <a href="../../views/payments/paymentdelete.php?id=<?= urlencode($payment['id']) ?>&scid=<?= urlencode($scid) ?>" onclick="return confirm('Are you sure you want to delete this record?')">
                                                <button class="btn btn-danger">Delete</button>
                                            </a>
                                        </td>
                                        <td>
                                        <a href="../../views/payments/addpayment.php?id=<?= urlencode($id) ?>&scid=<?= urlencode($scid) ?>"><button class="btn btn-success">Add New Payment</button></a>
                        ...
                        <a href="../../views/courses/views.php?id=<?= urlencode($id) ?>"><button class="btn btn-info">Back to Student Details</button></a>
                    </div>
                </div>
            </div>
        </div>
