              ...
              if ($stmt->execute()) {
                  ...
                  echo "<script>
                          setTimeout(function() {
                              ...
                              window.location.href = '../students/student_dashboard.php?student_id=" . urlencode($student_id) . "';
                          }, 100);
                      </script>";
                  exit();
              } else {
          ...
          <div class="card">
              ...
              <div class="card-body">
                  <form action="request.php" method="POST" enctype="multipart/form-data">
                      ...
                      <a href="student_dashboard.php" class="btn btn-secondary"><i class="fa fa-arrow-left"></i> Back</a>
                  </form>
              </div>
          </div>
      </div>
